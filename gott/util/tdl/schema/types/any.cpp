...
match_any::match_any(Vector<rule const *> const &vv,
...
bool match_any::accept_empty(Vector<rule const *> const &choices) {
  for (Vector<rule const *>::const_iterator it = choices.begin(); 
       it != choices.end(); ++it)
