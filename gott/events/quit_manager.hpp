...
public:
  quit_manager(main_loop &m);
  GOTT_EXPORT ~quit_manager();

  GOTT_EXPORT void enable_master();

public:
  GOTT_EXPORT static quit_manager *get_for(main_loop &m);
  GOTT_EXPORT static QID const qid;
